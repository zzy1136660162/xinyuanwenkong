  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        '@fantastic-admin/components': path.resolve(__dirname, 'packages/components/index.ts'),
        '@fantastic-admin/settings': path.resolve(__dirname, 'packages/settings/index.ts'),
        '@fantastic-admin/types': path.resolve(__dirname, 'packages/types/index.ts'),
      },
    },
    css: {
      preprocessorOptions: {
